...
.resume-template-blue-linear {
  ...
  width: 100%;
  min-height: 100%;
  padding: var(--tpl-page-padding-y, 24px) var(--tpl-page-padding-x, 24px) 14px;
  color: #000;
  display: flex;
...
.resume-section {
  margin-bottom: var(--tpl-section-gap, 6px);
}
...
.section-title {
  height: auto;
  line-height: 1.2;
  margin-top: var(--tpl-title-gap-top, 0);
  margin-bottom: var(--tpl-title-gap-bottom, 6px);
  padding: 0 0 5px;
  font-size: 20px;
  font-weight: 700;
  color: var(--tpl-primary, #3b65f6);
  background: transparent;
  border-bottom: 1px solid var(--tpl-primary, #3b65f6);
}

.section-title-self-intro {
  border-bottom: none;
  padding-bottom: 0;
}
